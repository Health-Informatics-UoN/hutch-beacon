  ...
  return(
    <div className="px-6">
      <div className="py-5">
        ...
        <p>&nbsp; 3 - The TREs TES executing agent (<a href="https://github.com/ohsu-comp-bio/funnel">Funnel</a>) uses the Beacon query in the input parameters to execute a <a href="https://hub.docker.com/r/hutchstack/beacon-omop-worker/tags">Beacon over OMOP</a> Docker image. </p>
