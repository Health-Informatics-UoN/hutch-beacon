...
public enum TesState
{
  ...
  /// </summary>
  [EnumMember(Value = "UNKNOWN")] UNKNOWNEnum = 1,

  /// <summary>
  /// Enum QUEUEDEnum for QUEUED
  /// </summary>
  [EnumMember(Value = "QUEUED")] QUEUEDEnum = 2,

  /// <summary>
  /// Enum INITIALIZINGEnum for INITIALIZING
  /// </summary>
  [EnumMember(Value = "INITIALIZING")] INITIALIZINGEnum = 3,

  /// <summary>
  /// Enum RUNNINGEnum for RUNNING
  /// </summary>
  [EnumMember(Value = "RUNNING")] RUNNINGEnum = 4,

  /// <summary>
  /// Enum PAUSEDEnum for PAUSED
  /// </summary>
  [EnumMember(Value = "PAUSED")] PAUSEDEnum = 5,

  /// <summary>
  /// Enum COMPLETEEnum for COMPLETE
  /// </summary>
  [EnumMember(Value = "COMPLETE")] COMPLETEEnum = 6,

  /// <summary>
  /// Enum EXECUTORERROREnum for EXECUTOR_ERROR
  /// </summary>
  [EnumMember(Value = "EXECUTOR_ERROR")] EXECUTORERROREnum = 7,

  /// <summary>
  /// Enum SYSTEMERROREnum for SYSTEM_ERROR
  /// </summary>
  [EnumMember(Value = "SYSTEM_ERROR")] SYSTEMERROREnum = 8,

  /// <summary>
  /// Enum CANCELEDEnum for CANCELED
  /// </summary>
  [EnumMember(Value = "CANCELED")] CANCELEDEnum = 9
}
